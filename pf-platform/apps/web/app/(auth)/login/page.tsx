  ...
  return (
    <>
      ...
      <button
        onClick={handleLogin}
        disabled={loading}
        className="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow-sm transition-all hover:bg-gray-50 hover:shadow-md disabled:cursor-not-allowed disabled:opacity-60"
      >
        {loading ? (
      ...
      <p className="mt-6 text-center text-xs text-gray-400">
        Only authorised Property Friends team members can sign in.
      </p>
    </>
  );
}
